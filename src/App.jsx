     ...
     <div onClick={onOuvrirLudo} style={st.carteLudo}>
        ...
        <div onClick={onOuvrirMultijoueur} style={{
          ...
          <div style={{ flex: 1, marginLeft: 12 }}>
            ...
            <div onClick={() => onOuvrirSpectateur && onOuvrirSpectateur()} style={{ ...st.carteLudo, background: 'linear-gradient(135deg,#1a1a2e,#16213e)', marginTop: 10 }}><div style={st.carteDeEmoji}>👁️</div><div style={{ flex: 1, marginLeft: 12 }}><div style={{ fontWeight: 800, fontSize: 16 }}>Regarder une partie</div><div style={{ fontSize: 13, color: 'rgba(255,255,255,0.75)' }}>Suis un match en direct</div></div><div style={{ fontSize: 20 }}>→</div></div>
</div>
          </div>
          <div style={{ fontSize: 20 }}>→</div>
        </div>
